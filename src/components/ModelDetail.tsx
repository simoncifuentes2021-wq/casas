    ...
    <>
      ...
      <section className="overflow-hidden bg-white py-14 md:py-20">
        <div className="container-page">
          ...
          <div className="no-scrollbar mt-5 flex snap-x snap-mandatory gap-3 overflow-x-auto pb-5 pr-8 md:hidden">
      ...
      <section className="overflow-hidden bg-warm py-14 md:py-20">
        <div className="container-page">
          ...
          <div className="no-scrollbar mt-8 flex snap-x snap-mandatory gap-3 overflow-x-auto pb-5 pr-8 md:hidden">
            {related.map((item) => (
